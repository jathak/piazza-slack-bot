...
other_piazza_names = os.environ.get('OTHER_PIAZZA_NAMES', default_other_names).split(',')
other_piazza_ids = os.environ.get('OTHER_PIAZZA_IDS', default_other_ids).split(',')
